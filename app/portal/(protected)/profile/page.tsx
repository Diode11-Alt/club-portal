                ...
                <div className="space-y-8">
                    <div className="bg-white rounded-[2rem] p-8 md:p-10 border border-cosmic-accent shadow-sm space-y-10">
                        ...
                        <div className="pt-8 border-t border-cosmic-accent">
                            <Link href="/portal/profile/edit" className="bg-cosmic-brand rounded-sm p-5 flex items-center justify-between group cursor-pointer hover:bg-cosmic-dark transition-all shadow-sm shadow-[#124E66]/20">
